...
const VRAAGTYPES = [
  ...
  { type: "Afbeelding als vraag", icon: "🖼️", uitleg: "Foto wordt getoond boven de vraag. Antwoorden zijn tekst." },
  { type: "Audio als vraag", icon: "🎵", uitleg: "Audioclip met afspeelknop. Antwoorden zijn tekst." },
  { type: "Raad het lied", icon: "🎶", uitleg: "Audio speelt automatisch 5 of 10 seconden, dan pauze. Antwoorden zijn tekst." },
  { type: "Video als vraag", icon: "🎬", uitleg: "YouTube-embed of MP4 video als vraag. Antwoorden zijn tekst." },
  { type: "Vervagend beeld", icon: "🌫️", uitleg: "Afbeelding begint maximaal wazig en wordt stapsgewijs scherper tijdens de tijdslimiet." },

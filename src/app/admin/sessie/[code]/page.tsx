          ...
          {waTemplate && (() => {
            ...
            return (
              <a href={waUrl} target="_blank" rel="noopener noreferrer"
                style={{ display: "inline-flex", alignItems: "center", gap: "6px", fontSize: "0.8rem", padding: "6px 14px", borderRadius: "8px", background: "#25D366", color: "#fff", fontWeight: 700, textDecoration: "none" }}>
